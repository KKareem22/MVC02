...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GymManagement.DAL.Models.Member", b =>
                {
                    ...
                    b.ToTable("Members", t =>
                        {
                            t.HasCheckConstraint("EmailCheck", "Email Like '%___@%___%.__%'");
                    ...
                    b.ToTable("sessions", t =>
                        {
                            ...
                            t.HasCheckConstraint("StartAndEndDateCheck", "EndDate > StartDate");
                        });
                });
            ...
            modelBuilder.Entity("Session01.Models.Plan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GymManagement.DAL.Models.MemberShip", b =>
                {
                    ...
                    b.HasOne("Session01.Models.Plan", "Plan")
                        .WithMany("Members")
