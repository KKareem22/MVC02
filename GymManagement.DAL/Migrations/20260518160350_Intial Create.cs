        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address_BuilderNumber = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Members", x => x.Id);
                    table.CheckConstraint("EmailCheck", "Email Like '%___@%___%.__%'");
                    table.CheckConstraint("PhoneCheck", "Phone Like '^01[0125][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("EmailCheck1", "Email Like '%___@%___%.__%'");
                    table.CheckConstraint("PhoneCheck1", "Phone Like '^01[0125][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("StartAndEndDateCheck", "EndDate > StartDate");
                    table.ForeignKey(
